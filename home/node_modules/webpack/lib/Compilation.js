...
const { MultiItemCache } = require("webpack/lib/CacheFacade");
...
const CodeGenerationError = require("webpack/lib/CodeGenerationError");
const CodeGenerationResults = require("webpack/lib/CodeGenerationResults");
const DependencyTemplates = require("webpack/lib/DependencyTemplates");
const Entrypoint = require("webpack/lib/Entrypoint");
const ErrorHelpers = require("webpack/lib/ErrorHelpers");
const FileSystemInfo = require("webpack/lib/FileSystemInfo");
const {
	connectChunkGroupAndChunk,
	connectChunkGroupParentAndChild
} = require("webpack/lib/GraphHelpers");
const { makeWebpackError } = require("webpack/lib/HookWebpackError");
...
const ModuleProfile = require("webpack/lib/ModuleProfile");
const ModuleRestoreError = require("webpack/lib/ModuleRestoreError");
const ModuleStoreError = require("webpack/lib/ModuleStoreError");
...
const buildChunkGraph = require("webpack/lib/buildChunkGraph");
const BuildCycleError = require("webpack/lib/errors/BuildCycleError");
const { Logger, LogType } = require("webpack/lib/logging/Logger");
const StatsFactory = require("webpack/lib/stats/StatsFactory");
const StatsPrinter = require("webpack/lib/stats/StatsPrinter");
const { equals: arrayEquals } = require("webpack/lib/util/ArrayHelpers");
const AsyncQueue = require("webpack/lib/util/AsyncQueue");
const LazySet = require("webpack/lib/util/LazySet");
const { provide } = require("webpack/lib/util/MapHelpers");
...
const {
	...
	createFakeHook
} = require("webpack/lib/util/deprecation");
const { getRuntimeKey } = require("webpack/lib/util/runtime");
const { isSourceEqual } = require("webpack/lib/util/source");

/** @template T @typedef {import("tapable").AsArray<T>} AsArray<T> */
/** @typedef {import("webpack-sources").Source} Source */
/** @typedef {import("webpack/declarations/WebpackOptions").EntryDescriptionNormalized} EntryDescription */
/** @typedef {import("webpack/declarations/WebpackOptions").OutputNormalized} OutputOptions */
/** @typedef {import("webpack/declarations/WebpackOptions").StatsOptions} StatsOptions */
...
/** @typedef {import("webpack/lib/AsyncDependenciesBlock")} AsyncDependenciesBlock */
/** @typedef {import("webpack/lib/Cache")} Cache */
/** @typedef {import("webpack/lib/CacheFacade")} CacheFacade */
/** @typedef {import("webpack/lib/ChunkGroup").ChunkGroupOptions} ChunkGroupOptions */
...
/** @typedef {import("webpack/lib/Dependency").ReferencedExport} ReferencedExport */
/** @typedef {import("webpack/lib/DependencyTemplate")} DependencyTemplate */
/** @typedef {import("webpack/lib/Entrypoint").EntryOptions} EntryOptions */
/** @typedef {import("webpack/lib/Module").CodeGenerationResult} CodeGenerationResult */
/** @typedef {import("webpack/lib/ModuleFactory")} ModuleFactory */
/** @typedef {import("webpack/lib/ModuleFactory").ModuleFactoryCreateDataContextInfo} ModuleFactoryCreateDataContextInfo */
/** @typedef {import("webpack/lib/RequestShortener")} RequestShortener */
/** @typedef {import("webpack/lib/RuntimeModule")} RuntimeModule */
/** @typedef {import("webpack/lib/Template").RenderManifestEntry} RenderManifestEntry */
/** @typedef {import("webpack/lib/Template").RenderManifestOptions} RenderManifestOptions */
...
/** @template T @typedef {import("webpack/lib/util/deprecation").FakeHook<T>} FakeHook<T> */
/** @typedef {import("webpack/lib/util/runtime").RuntimeSpec} RuntimeSpec */
...
const deprecatedNormalModuleLoaderHook = util.deprecate(
	compilation => {
		return require("webpack/lib/NormalModule").getCompilationHooks(compilation).loader;
	},
...
BREAKING CHANGE: Asset processing hooks in Compilation has been merged into a single Compilation.hooks.processAssets hook.`;
	...
	finish(callback) {
		if (this.profile) {
			...
			const ParallelismFactorCalculator = require("webpack/lib/util/ParallelismFactorCalculator");
