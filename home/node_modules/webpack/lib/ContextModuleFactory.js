...
const { cachedSetProperty } = require("webpack/lib/util/cleverMerge");
const { createFakeHook } = require("webpack/lib/util/deprecation");
const { join } = require("webpack/lib/util/fs");

/** @typedef {import("webpack/lib/ContextModule").ContextModuleOptions} ContextModuleOptions */
/** @typedef {import("webpack/lib/ContextModule").ResolveDependenciesCallback} ResolveDependenciesCallback */
...
/** @typedef {import("webpack/lib/ResolverFactory")} ResolverFactory */
/** @typedef {import("webpack/lib/dependencies/ContextDependency")} ContextDependency */
