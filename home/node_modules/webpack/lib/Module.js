...
const DependenciesBlock = require("webpack/lib/DependenciesBlock");
const ModuleGraph = require("webpack/lib/ModuleGraph");
const RuntimeGlobals = require("webpack/lib/RuntimeGlobals");
const { first } = require("webpack/lib/util/SetHelpers");
const { compareChunksById } = require("webpack/lib/util/comparators");
...
/** @typedef {import("webpack/lib/ExportsInfo").UsageStateType} UsageStateType */
/** @typedef {import("webpack/lib/FileSystemInfo")} FileSystemInfo */
/** @typedef {import("webpack/lib/ModuleGraphConnection").ConnectionState} ConnectionState */
...
/** @template T @typedef {import("webpack/lib/util/LazySet")<T>} LazySet<T> */
/** @template T @typedef {import("webpack/lib/util/SortableSet")<T>} SortableSet<T> */
