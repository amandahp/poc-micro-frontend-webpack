...
const { getScheme } = require("webpack/lib/util/URLAbsoluteSpecifier");
const { cachedCleverMerge, cachedSetProperty } = require("webpack/lib/util/cleverMerge");
const { join } = require("webpack/lib/util/fs");
const { parseResource } = require("webpack/lib/util/identifier");

/** @typedef {import("webpack/declarations/WebpackOptions").ModuleOptionsNormalized} ModuleOptions */
/** @typedef {import("webpack/lib/Generator")} Generator */
...
/** @typedef {import("webpack/lib/dependencies/ModuleDependency")} ModuleDependency */
